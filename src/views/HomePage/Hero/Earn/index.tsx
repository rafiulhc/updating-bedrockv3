  ...
  return (
    <>
      <Main style={{border:"1px solid red"}}>
        <EarnText>
          <Title textAlign={width <= 480 ? "left" : "left"} fontSize={width > 786 ? "50px" : "30px"}>
            Earn Bitcoin <br /> by Staking Rock
          </Title>
          <Paragraph opacity="0.75" fontSize="17px" marginTop="30px" marginbottom="60px" lineheight="22px" letterspacing="0.02em">
